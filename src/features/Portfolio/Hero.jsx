export default function Hero() {
  return (
    <div className="flex flex-col gap-8 p-12 max-w-[900px] justify-center max-[800px]:p-8 max-[800px]:gap-6">
      <h1 className="font-raleway text-5xl md:text-[3.5rem] font-bold text-transparent bg-[linear-gradient(135deg,#1a1a3a_0%,#307ff6_50%,#1a1a3a_100%)] bg-[length:200%_auto] bg-clip-text [-webkit-background-clip:text] animate-shimmer m-0 leading-tight tracking-[-0.02em] max-[800px]:text-[2.25rem]">
        Hello, my name is Kevin.
      </h1>
      
      <p className="font-raleway text-lg font-light text-gray-800 m-0 leading-[1.8] tracking-[0.01em] max-[800px]:text-base max-[800px]:leading-[1.7]">
      ...
      <div>
        ...
        <div className="flex gap-4 flex-wrap mt-2">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/90 border border-gray-300 rounded-md text-gray-800 font-raleway text-[0.95rem] font-medium no-underline transition-all duration-200 hover:bg-blue-500 hover:border-blue-600 hover:text-white hover:-translate-y-[1px] shadow-md hover:shadow-lg max-[800px]:text-sm max-[800px]:px-4 max-[800px]:py-2"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/90 border border-gray-300 rounded-md text-gray-800 font-raleway text-[0.95rem] font-medium no-underline transition-all duration-200 hover:bg-pink-500 hover:border-pink-600 hover:text-white hover:-translate-y-[1px] shadow-md hover:shadow-lg max-[800px]:text-sm max-[800px]:px-4 max-[800px]:py-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/90 border border-gray-300 rounded-md text-gray-800 font-raleway text-[0.95rem] font-medium no-underline transition-all duration-200 hover:bg-blue-400 hover:border-blue-500 hover:text-white hover:-translate-y-[1px] shadow-md hover:shadow-lg max-[800px]:text-sm max-[800px]:px-4 max-[800px]:py-2"
          >
