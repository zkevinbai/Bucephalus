...
export default function Skills() {
  return (
    <div className="flex flex-col gap-6 p-8 items-center justify-center max-[800px]:p-6 max-[800px]:gap-4">
      ...
      <div className="w-full bg-white/50 border border-gray-300/40 rounded-xl backdrop-blur-sm p-6 grid grid-cols-4 grid-rows-4 gap-4 justify-items-center items-center max-[800px]:grid-cols-3 max-[800px]:p-4 max-[800px]:gap-3">
